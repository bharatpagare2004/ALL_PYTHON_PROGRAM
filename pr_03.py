...
def read_matrix():
       ...
       c = int(input("Enter number of columns in FirstMatrix : "))
# in python initilization is needed before indexing.
       mat = init_matrix(mat, r, c) # matrix 1initialization with 0s
       for i in range(0, r):
          for j in range(0, c):
              mat[i][j] = int(input("Enter an element : "))
              return mat, r, c# Addition of two matrices
...
res_matrix = init_matrix(res_matrix, r1, c2) # matrixfor storing result

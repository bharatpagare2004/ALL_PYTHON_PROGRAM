...
marksInFDS = []
noStudent = int(input("enter a number of student: "))
...
while bharat ==1:
         ...
         print("(5). the highest score with its frequncy.")
         print("(6). exit.")
   # this for choice ...
         ...
         if choice == 1:
            ...
            print("the lowest is = ",lowest_mark(marksInFDS))
         elif choice == 4:
           print("the absent student in the class is = ",absent(marksInFDS))
         elif choice == 5:
           print("marks with high frequency is = ",maxFre(marksInFDS))
         elif choice == 6:
